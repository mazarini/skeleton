...
class AdminController extends CrudController
{
    ...
    protected string $editTemplate = 'admin/edit.html.twig';
    protected string $showTemplate = 'admin/show.html.twig';
    protected string $listTemplate = 'admin/index.html.twig';

    #[Route('')]
    public function default(UserRepository $userRepository): Response
    {
        return $this->redirectToRoute('app_admin_user_page', ['page' => 1], Response::HTTP_SEE_OTHER);
    }

    #[Route('/index.html', name: 'app_admin_user_index', methods: ['GET'])]
    public function index(UserRepository $userRepository): Response
    {
        return $this->pageAction($userRepository, null);
    }

    #[Route('/page-{page}.html', name: 'app_admin_user_page', methods: ['GET'])]
    ...
    #[Route('/new.html', name: 'app_admin_user_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        return $this->editAction($request, new User(), $entityManager);
    }

    #[Route('/{id}/show.html', name: 'app_admin_user_show', methods: ['GET'])]
    public function show(User $user): Response
    {
        return $this->showAction($user);
    }

    #[Route('/{id}/edit.html', name: 'app_admin_user_edit', methods: ['GET', 'POST'])]
    ...
    {
        return $this->redirectToRoute('app_admin_user_index', $parameters, Response::HTTP_SEE_OTHER);
    }
    ...
    protected function redirectToShow(): Response
    {
        ...
        return $this->redirectToRoute('app_admin_user_show', $parameters, Response::HTTP_SEE_OTHER);
    }
}
