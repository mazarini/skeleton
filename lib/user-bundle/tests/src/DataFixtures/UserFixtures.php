...
final class UserFixtures extends Fixture
{
    ...
    private function getUserData(): array
    {
        return [
            ...
            ['Jane Doe', 'jane_admin', 'kitten', 'admin@symfony.com', [User::ROLE_ADMIN]],
            ['Tom Doe', 'tom_admin', 'kitten', 'admin2@symfony.com', [User::ROLE_ADMIN]],
            ['John Doe', 'john_user', 'kitten', 'user@symfony.com', [User::ROLE_USER]],
        ];
    }
}
